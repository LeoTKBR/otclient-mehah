...
function onTalk(name, level, mode, message, channelId, creaturePos)
  ...
  if (mode == MessageModes.Say or mode == MessageModes.Whisper or mode == MessageModes.Yell or
	...
	-- Messagem Colorida/Cor/Personalizada
	if (name:find("ADM")) then
	staticText:setColor(tocolor("#e825d4"))
	elseif localPlayer and g_game.isOnline() then
	staticText:setColor(tocolor("#ffbc47"))
	end
